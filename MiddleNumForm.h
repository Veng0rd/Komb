...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->input->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &MiddleNumForm::Check_KeyPress);
			// 
			// label3
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Himalaya", 36, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(438, 80);
			...
			this->label5->Size = System::Drawing::Size(267, 21);
			this->label5->TabIndex = 14;
			this->label5->Text = L"Уровень: средний (числа от 10 до 99)";
			// 
			// label4
			// 
